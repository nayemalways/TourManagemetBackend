...
// export const fileUploadMiddlware = () => async (req: Request, res: Response, next: NextFunction) => {
...
//                 const uniqueFileName = Math.random().toString(36).substring(2) + "_" + Date.now() + "-" + fileName + "." + extension;
