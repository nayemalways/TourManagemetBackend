...
const createBooking = async (payload: Partial<IBooking>, userId: string) => {
       ...
       try {
            ...
            if(!user?.phone || !user?.address) {
                throw new AppError(500, "Please update your profile information phone & address");
            }
            ...
            const updateBooking = await Booking.findByIdAndUpdate(booking[0]._id, {payment: payment[0]._id}, {new: true, runValidators: true, session })
