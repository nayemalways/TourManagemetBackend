...
export const generatePDF = async (
  ...
  try {
    return new Promise((resolve, reject) => {
      ...
      y = 0;
      doc.rect(0, y, docWidth, headerHeight).fill(PRIMARY_COLOR);
      ...
      doc
        .font('Helvetica')
        .text(formatDate(invoiceData.bookingDate), margin + 160, y);
      ...
      doc.rect(tableLeft, tableTop, tableWidth, rowHeight).fill(LIGHT_GRAY);
      ...
      doc
        ...
        .fontSize(12)
        .font('Helvetica-Bold')
        .text('Description', tableLeft + cellPadding, tableTop + 10, {
          width: descriptionWidth,
        });

      doc.text('Guests', tableLeft + descriptionWidth, tableTop + 10, {
        width: guestsWidth,
        align: 'center',
      });
      ...
      doc.text(
        'Amount',
        tableLeft + descriptionWidth + guestsWidth,
        tableTop + 10,
        { width: amountWidth - cellPadding, align: 'right' }
      );

      // Draw separator line
      doc
        .strokeColor(SEPARATOR_GRAY)
        .lineWidth(1)
      ...
      // --- Line Item Content ---
      doc.fillColor(SECONDARY_COLOR).font('Helvetica');
      ...
      doc.text(
        String(invoiceData.guestCount),
        tableLeft + descriptionWidth,
        y + cellPadding,
        { width: guestsWidth, align: 'center' }
      );
      ...
      doc.rect(0, footerY, docWidth, footerHeight).fill(SECONDARY_COLOR);
      ...
      doc
        ...
        .font('Helvetica')
        .text(
          `Thank you for booking your adventure with ${ORGANIZATION_NAME}.`,
          0,
          footerY + 20,
          { align: 'center' }
        );
      ...
      doc.text(
        'Contact us at support@tourista.com or call 1-800-TOUR-ADV',
        0,
        footerY + 40,
        { align: 'center' }
      );
